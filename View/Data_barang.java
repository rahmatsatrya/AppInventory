...
public class Data_barang extends javax.swing.JDialog {
    ...
    private void pilihData(){
        ...
        brg.setKode_barang(tbl_barang.getModel().getValueAt(row, 1).toString());
        brg.setNama_barang(tbl_barang.getModel().getValueAt(row, 4).toString());
        brg.setSatuan(tbl_barang.getModel().getValueAt(row, 5).toString());
        brg.setHarga(Long.parseLong((tbl_barang.getModel().getValueAt(row, 6).toString())));
        brg.setStok(Integer.parseInt(tbl_barang.getModel().getValueAt(row, 7).toString()));
