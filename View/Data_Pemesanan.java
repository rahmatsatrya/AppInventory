...
public class Data_Pemesanan extends javax.swing.JDialog {
    ...
    private service_pemesanan servisPem = new DAO_Pemesanan();
    private TableMod_Pesanan tblModel = new TableMod_Pesanan();
    ...
    private void loadData(){
        List<model_pemesanan> list = servisPem.getData();
        tblModel.setData(list);
    }
    
    private void pencarian(){
        List<model_pemesanan> list = servisPem.pencarian(t_search.getText());
        tblModel.setData(list);
    }
