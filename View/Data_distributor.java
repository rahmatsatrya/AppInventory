...
public class Data_distributor extends javax.swing.JDialog {
    ...
    public model_distributor dist = new model_distributor();
    ...
    private void initComponents() {
        ...
        tbl_distributor.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        ...
        tbl_distributor.setIntercellSpacing(new java.awt.Dimension(5, 0));
        tbl_distributor.setRowHeight(25);
    ...
    private void pencarian(){
        List<model_distributor> list = servis.pencarian(t_search.getText());
        tblModel.setData(list);
    }
    ...
    private void pilihData(){
        ...
        dist.setId_distributor(tbl_distributor.getModel().getValueAt(row, 1).toString());
        dist.setNama_distributor(tbl_distributor.getModel().getValueAt(row, 2).toString());
