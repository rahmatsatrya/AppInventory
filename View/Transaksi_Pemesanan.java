...
import Dao.DAO_chartPemesanan;
import Dao.DAO_detPemesanan;
import TableModel.TableMod_Pesanan;
import TableModel.TableMod_chartPesanan;
import TableModel.TableMod_detPesanan;
...
public class Transaksi_Pemesanan extends javax.swing.JPanel {
    ...
    private service_pemesanan servisPesanan = new DAO_Pemesanan();
    private service_detPemesanan servisDetPes = new DAO_detPemesanan();
    private service_chartPesanan servisChartPes = new DAO_chartPemesanan();
    
    private TableMod_Pesanan tblModelPesanan = new TableMod_Pesanan();
    private TableMod_detPesanan tblModelDetPes = new TableMod_detPesanan();
    private TableMod_chartPesanan tblModelChartPes = new TableMod_chartPesanan();
...
//    private final int noColumnWidth = 50;
    ...
    public Transaksi_Pemesanan(String id) {
        initComponents();
        lb_id.setText(id);
        tbl_barang.setModel(tblModelPesanan);
        tbl_detail.setModel(tblModelDetPes);
        tbl_sementara.setModel(tblModelChartPes);
//        setColumnWidth();
        loadData();
        loadDataSementara();
    ...
    private void initComponents() {
        ...
        t_nopesanan = new javax.swing.JTextField();
        ...
        jLabel4.setText("Detail Pesanan Barang");
        ...
        jLabel1.setText("Data Pesanan Barang");
        ...
        t_nopesanan.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        t_nopesanan.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        t_nopesanan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                t_nopesananActionPerformed(evt);
            }
        });
        ...
        t_tanggal.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(t_nopesanan, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        t_idDist.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        ...
        t_namaDist.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(t_namaBarang, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btn_tambahBarang, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        mainPanel.add(tambahPemesanan, "card3");
...
//        mengubah tampilan ke tambah data
        ...
        t_nopesanan.setEnabled(false); //set false agar tombol no.pesanan bisa diklik
        t_nopesanan.setText(servisPesanan.nomor());//melakukan penomoran otomatis melalui DAO_pemesanan
        ...
        servisDetPes.sumTotal(detPes);
        lb_total.setText("Rp. " + detPes.getSubtotal_pesan().toString()); // label subtotal
    ...
    private void tbl_barangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_barangMouseClicked
        ...
        List <model_detPemesanan> list = servisDetPes.getData(id);
        tblModelDetPes.setData(list);
...
//        resetForm();
    ...
    private void t_nopesananActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_t_nopesananActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_t_nopesananActionPerformed
    ...
    private void btn_tambahBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahBarangActionPerformed
        ...
        detPes.setJml_pesan(jumlah);
        detPes.setSubtotal_pesan(subtotal);
        detPes.setStatus(status);
        
        chartPes.setMod_barang(brg);
        chartPes.setMod_pesan(detPes);
        
        servisChartPes.tambahData(chartPes);
...
//        t_satuan.setText        (tbl_barang.getModel().getValueAt(row, 2).toString());
    ...
    private javax.swing.JTextField t_nopesanan;
    ...
    private void loadData() {
       ...
       List <model_pemesanan> list = servisPesanan.getData();
       tblModelPesanan.setData(list);
    }
    
    private void loadDataSementara() {
        List <model_chartPesanan> list = servisChartPes.getData();
       tblModelChartPes.setData(list);
    }

    private void simpanData() {
            String noPes           = t_nopesanan.getText();
            ...
            model_barang brg = new model_barang();
            model_pemesanan modPes = new model_pemesanan();
            model_detPemesanan modDetPes = new model_detPemesanan();
            
            // menyimpan tabel pemesanan
            modPes.setNo_pesan(noPes);
            modPes.setTgl_pesan(tgl_pesan);
            modPes.setTotal_pesan(total);
            
            // distributor
            dis.setId_distributor(id_Dis);
            modPes.setIdDistributor(dis);
            
            
            // pengguna
            user.setId_pengguna(id_peng);
            modPes.setIdPengguna(user);
            
            // menyimpan detail pemesanan
            modDetPes.setNo_detPesan(modPes);
            modDetPes.setKode_barang(brg);
            modDetPes.setStatus(status);
            
            
            servisPesanan.tambahData(modPes);
            servisDetPes.tambahData(modDetPes);
            servisDetPes.hapusSementara(modDetPes);
            tblModelPesanan.tambahData(modPes);
            tampilPanel();
            loadData();
            resetForm();
    ...
    private void PerbaruiDataSementara() {
        ...
        if (index != -1){
            model_chartPesanan chartPes = tblModelChartPes.getData(tbl_sementara.convertRowIndexToModel(index));
                ...
                model_barang brg = new model_barang();
                model_chartPesanan mod_chartPes = new model_chartPesanan();
                model_detPemesanan mod_detPes = new model_detPemesanan();
                
                brg.setKode_barang(kode);
                brg.setNama_barang(nama);
                brg.setHarga(harga);
                mod_detPes.setJml_pesan(jumlah);
                mod_detPes.setSubtotal_pesan(subtotal);
                
                mod_chartPes.setMod_barang(brg);
                mod_chartPes.setMod_pesan(mod_detPes);
                
                servisChartPes.perbaruiData(mod_chartPes);
                tblModelChartPes.perbaruiData(index, mod_chartPes);
                
                servisDetPes.sumTotal(mod_detPes);
                lb_total.setText("Rp. " + mod_detPes.getSubtotal_pesan().toString()); // label subtotal
    ...
    private void hapusDataChartPes() {
        ...
        if (index != -1){
            ...
            if(JOptionPane.showConfirmDialog(null, "Anda yakin ingin menghapus data?","Konfirmasi",JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION){
                servisChartPes.hapusData(chartPes);
                tblModelChartPes.hapusData(index);
                loadDataSementara();
                resetForm();
                bersihBarang();
                model_detPemesanan detPes = new model_detPemesanan();
    ...
    private void pencarian() {
        List<model_pemesanan> list = servisPesanan.pencarian(t_cari.getText());
        tblModelPesanan.setData(list);
    }
    ...
    private void hapusData() {
        ...
        if (index != -1){
            model_pemesanan modPes = tblModelPesanan.getData(tbl_barang.convertRowIndexToModel(index));
            if(JOptionPane.showConfirmDialog(null, "Anda yakin ingin menghapus data?","Konfirmasi",JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION){
                servisPesanan.hapusData(modPes);
                tblModelPesanan.hapusData(index);
                loadData();
